...
class NounAdjective {
  ...
  singNominativeTrans(){
    return "the " + myAdjective.meaning + " " + this.singMeaning;
  }
  ...
  singAblativeTrans(){
    return " with the " + myAdjective.adjTrans + " " + this.singMeaning;
  }
  ...
  plAblativeTrans(){
    return " with the " + myAdjective.adjTrans + " " + this.plMeaning;
  }
